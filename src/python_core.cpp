...
static PyMethodDef module_methods[] = {
    ...
    { "process_create_user",            (PyCFunction)py_process_create_user,            METH_VARARGS | METH_KEYWORDS, "Create user process"                    },
    ...
    { "process_thread_open_alertable",  (PyCFunction)py_process_thread_open_alertable,  METH_VARARGS | METH_KEYWORDS, "Open alertable thread in the process"   },
    ...
    { "process_thread_queue_user_apc",  (PyCFunction)py_process_thread_queue_user_apc,  METH_VARARGS | METH_KEYWORDS, "Queue user APC in the thread"           },
